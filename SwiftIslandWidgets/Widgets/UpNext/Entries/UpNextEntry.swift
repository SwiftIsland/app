...
struct UpNextEntry: TimelineEntry {
    ...
    static func forPreview() -> UpNextEntry {
        UpNextEntry(date: .now, event: Event.forPreview(startDate: Date(timeIntervalSinceNow: 37 * 60), activity: Activity.forPreview(title: "Amazing workshop", type: .workshop, duration: 120 * 60)), isTooFarInTheFuture: false)
    }
